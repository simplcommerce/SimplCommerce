...
namespace SimplCommerce.Module.PaymentCashfree.Areas.PaymentCashfree.Components
{
    public class CashfreeLandingViewComponent : ViewComponent
    {
        ...
        public CashfreeLandingViewComponent(ICartService cartService, IWorkContext workContext,
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var message = "appId=" + cashfreeSetting.AppId + "&orderId=" + orderId + "&orderAmount=" + amount +
                          "&returnUrl=" + cashfreeSetting.ReturnURL + "&paymentModes=" + cashfreeSetting.PaymentModes;
            ...
            var model = new CashfreeCheckoutForm
            {
                ...
                CustomerPhone =
                    string.IsNullOrWhiteSpace(currentUser.PhoneNumber)
                        ? "1234567890"
                        : currentUser.PhoneNumber, // Phone number is mandatory for Cashfree payment
