...
namespace SimplCommerce.Module.Core.Extensions
{
    ...
    {
        public static Func<int, LocalizedHtmlString> GetTextPartsFunction(this LocalizedHtmlString localizedHtmlString,
            params string[] splitTokens)
        {
            ...
            {
                return i < originalTextParts.Count && i < localizedTextParts.Count
