...
(function() {
    angular
        ...
        .controller("StateProvinceListCtrl",
            ["countryService", "stateProvinceService", "translateService", "$stateParams", StateProvinceListCtrl]);
    ...
    function StateProvinceListCtrl(countryService, stateProvinceService, translateService, $stateParams) {
        ...
        vm.deleteStateOrProvince = function deleteStateOrProvince(stateOrProvince) {
            bootbox.confirm(
                "Are you sure you want to delete this state or province: " + simplUtil.escapeHtml(stateOrProvince.name),
                function(result) {
                    if (result) {
