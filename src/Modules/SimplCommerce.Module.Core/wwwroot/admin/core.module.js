                    ...
                    .state("customergroups",
                        {
                            url: "/customergroups",
                            templateUrl:
                                "_content/SimplCommerce.Module.Core/admin/customergroups/customergroup-list.html",
                    ...
                    .state("customergroup-create",
                        {
                            ...
                            templateUrl:
                                "_content/SimplCommerce.Module.Core/admin/customergroups/customergroup-form.html",
                    ...
                    .state("states-provinces",
                        {
                            ...
                            templateUrl:
                                "_content/SimplCommerce.Module.Core/admin/stateprovince/state-province-list.html",
                    ...
                    .state("state-province-create",
                        {
                            ...
                            templateUrl:
                                "_content/SimplCommerce.Module.Core/admin/stateprovince/state-province-form.html",
