    ...
    public static class CoreSeedData
    {
        public static void SeedData(ModelBuilder builder)
        {
            builder.Entity<AppSetting>().HasData(
                ...
                {
                    Module = "Core", IsVisibleInCommonSettingPage = true, Value = "1.0"
                },
                new AppSetting("Global.AssetBundling")
                {
                    Module = "Core", IsVisibleInCommonSettingPage = true, Value = "false"
                },
                new AppSetting("Theme") {Module = "Core", IsVisibleInCommonSettingPage = false, Value = "Generic"},
                new AppSetting("Global.DefaultCultureUI")
                {
                    Module = "Core", IsVisibleInCommonSettingPage = true, Value = "en-US"
                },
                ...
                {
                    Module = "Core", IsVisibleInCommonSettingPage = true, Value = "2"
                }
            );
