...
(function() {
    angular
        ...
        .controller("ShippingProviderListCtrl",
            ["shippingProviderService", "translateService", ShippingProviderListCtrl]);
    ...
    function ShippingProviderListCtrl(shippingProviderService, translateService) {
        ...
        vm.enableProvider = function enableProvider(provider) {
            bootbox.confirm("Are you sure you want to enable this " + simplUtil.escapeHtml(provider.name) + " provider",
                function(result) {
                    if (result) {
        ...
        vm.disableProvider = function disableProvider(provider) {
            bootbox.confirm(
                "Are you sure you want to disable this " + simplUtil.escapeHtml(provider.name) + " provider",
                function(result) {
                    if (result) {
