...
namespace SimplCommerce.Module.Orders.Areas.Orders.Controllers
{
    ...
    public class InvoiceApiController : Controller
    {
        ...
        public InvoiceApiController(IRepository<Order> orderRepository, IWorkContext workContext,
            IRazorViewRenderer viewRender, IPdfConverter pdfConverter, ICurrencyService currencyService)
        {
        ...
        public async Task<IActionResult> Print(long id)
        {
            ...
            var invoiceHtml =
                await _viewRender.RenderViewToStringAsync("/Areas/Orders/Views/Shared/InvoicePdf.cshtml", model);
            var pdf = _pdfConverter.Convert(invoiceHtml);
