                    ...
                    .state("contact-area",
                        {
                            url: "/contact-area",
                            templateUrl:
                                "_content/SimplCommerce.Module.Contacts/admin/contact-area/contact-area-list.html",
                    ...
                    .state("contact-area-create",
                        {
                            ...
                            templateUrl:
                                "_content/SimplCommerce.Module.Contacts/admin/contact-area/contact-area-form.html",
                    ...
                    .state("contact-area-translation",
                        {
                            ...
                            templateUrl:
                                "_content/SimplCommerce.Module.Contacts/admin/contact-area/contact-area-translation-form.html",
