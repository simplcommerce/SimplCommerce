...
namespace SimplCommerce.Module.PaymentNganLuong.ViewModels
{
    public class PaymentStatusResponse
    {
        ...
        [JsonProperty("data")] public PaymentStatusResponseData Data { get; set; }
    }
    ...
    public class PaymentStatusResponseData
    {
        ...
        [JsonProperty("fee_shipping")] public decimal? FeeShipping { get; set; }

        [JsonProperty("return_url")] public string ReturnUrl { get; set; }

        [JsonProperty("cancel_url")] public string CancelUrl { get; set; }

        [JsonProperty("buyer_fullname")] public string BuyerFullname { get; set; }

        [JsonProperty("buyer_email")] public string BuyerEmail { get; set; }

        [JsonProperty("buyer_mobile")] public string BuyerMobile { get; set; }

        [JsonProperty("buyer_address")] public string BuyerAddress { get; set; }

        [JsonProperty("affiliate_code")] public string AffiliateCode { get; set; }
