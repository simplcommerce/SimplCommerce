                    ...
                    .state("category-translation",
                        {
                            ...
                            templateUrl:
                                "_content/SimplCommerce.Module.Catalog/admin/category/category-translation-form.html",
                    ...
                    .state("product-option",
                        {
                            url: "/product-option",
                            templateUrl:
                                "_content/SimplCommerce.Module.Catalog/admin/product-option/product-option-list.html",
                    ...
                    .state("product-option-create",
                        {
                            ...
                            templateUrl:
                                "_content/SimplCommerce.Module.Catalog/admin/product-option/product-option-form.html",
                    ...
                    .state("product-attribute-group",
                        {
                            ...
                            templateUrl:
                                "_content/SimplCommerce.Module.Catalog/admin/product-attribute-group/product-attribute-group-list.html",
                    ...
                    .state("product-attribute-group-create",
                        {
                            ...
                            templateUrl:
                                "_content/SimplCommerce.Module.Catalog/admin/product-attribute-group/product-attribute-group-form.html",
                    ...
                    .state("product-attribute",
                        {
                            ...
                            templateUrl:
                                "_content/SimplCommerce.Module.Catalog/admin/product-attribute/product-attribute-list.html",
                    ...
                    .state("product-attribute-create",
                        {
                            ...
                            templateUrl:
                                "_content/SimplCommerce.Module.Catalog/admin/product-attribute/product-attribute-form.html",
                    ...
                    .state("product-template",
                        {
                            ...
                            templateUrl:
                                "_content/SimplCommerce.Module.Catalog/admin/product-template/product-template-list.html",
                    ...
                    .state("product-template-create",
                        {
                            ...
                            templateUrl:
                                "_content/SimplCommerce.Module.Catalog/admin/product-template/product-template-form.html",
                    ...
                    .state("product-translation",
                        {
                            ...
                            templateUrl:
                                "_content/SimplCommerce.Module.Catalog/admin/product/product-translation-form.html",
                    ...
                    .state("widget-product-create",
                        {
                            ...
                            templateUrl:
                                "_content/SimplCommerce.Module.Catalog/admin/product-widget/product-widget-form.html",
                    ...
                    .state("widget-category-create",
                        {
                            ...
                            templateUrl:
                                "_content/SimplCommerce.Module.Catalog/admin/category-widget/category-widget-form.html",
                    ...
                    .state("widget-simple-product-create",
                        {
                            ...
                            templateUrl:
                                "_content/SimplCommerce.Module.Catalog/admin/simple-product-widget/simple-product-widget-form.html",
                    ...
                    .state("product-prices",
                        {
                            url: "/product-prices",
                            templateUrl:
                                "_content/SimplCommerce.Module.Catalog/admin/product-price/product-price-form.html",
                    ...
                    .state("product-clone",
                        {
                            ...
                            templateUrl:
                                "_content/SimplCommerce.Module.Catalog/admin/product-clone/product-clone-form.html",
