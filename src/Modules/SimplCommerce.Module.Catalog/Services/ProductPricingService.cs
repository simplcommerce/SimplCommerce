...
namespace SimplCommerce.Module.Catalog.Services
{
    public class ProductPricingService : IProductPricingService
    {
        ...
        {
            return CalculateProductPrice(product.Price, product.OldPrice, product.SpecialPrice,
            ...
            DateTimeOffset? specialPriceStart, DateTimeOffset? specialPriceEnd)
        {
            ...
            {
                Price = calculatedPrice, OldPrice = oldPrice, PercentOfSaving = percentOfSaving
            };
        }
    }
}
