        ...
        .controller("CommentCtrl",
            [
                ...
                function($scope, commentService) {
                    var vm = this;
                    vm.comment = {
                        entityId: window.simplCommentEntity.entityId,
                        entityTypeId: window.simplCommentEntity.entityTypeId
                    };
                    vm.comments = [];
                    vm.search = "";
                    vm.commentCount = 0;
                    ...
                    function getComments(page) {
                        commentService.getComments(vm.comment.entityId, vm.comment.entityTypeId, vm.search, page).then(
                            function(result) {
