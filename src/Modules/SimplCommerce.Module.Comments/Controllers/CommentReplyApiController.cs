...
namespace SimplCommerce.Module.Reviews.Controllers
{
    ...
    [Route("api/comment-replies")]
    public class CommentReplyApiController : Controller
    {
        private readonly IReplyRepository _replyRepository;
        private readonly IMediator _mediator;

        public CommentReplyApiController(IReplyRepository replyRepository, IMediator mediator)
        {
