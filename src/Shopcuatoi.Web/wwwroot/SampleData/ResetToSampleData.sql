...
INSERT [dbo].[Core_Product] ([Id], [ShortDescription], [Description], [Specification], [Price], [OldPrice], [DisplayOrder], [BrandId], [Name], [SeoTitle], [MetaTitle], [MetaKeywords], [MetaDescription], [IsPublished], [PublishedOn], [IsDeleted], [CreatedOn], [UpdatedOn], [CreatedById], [ThumbnailImageId], [UpdatedById]) VALUES (1, N'Màn hình Retina 3D Touch
...
INSERT [dbo].[Core_Product] ([Id], [ShortDescription], [Description], [Specification], [Price], [OldPrice], [DisplayOrder], [BrandId], [Name], [SeoTitle], [MetaTitle], [MetaKeywords], [MetaDescription], [IsPublished], [PublishedOn], [IsDeleted], [CreatedOn], [UpdatedOn], [CreatedById], [ThumbnailImageId], [UpdatedById]) VALUES (2, N'Màn hình Retina 3D Touch
Chip xử lý A9 64-bit tiên tiến; Hệ điều hành iOS 9
RAM 2GB; ROM 16GB
Camera trước 5MP; Camera sau 12MP
Quay phim độ phân giải 4K
...
Với kích thước màn hình không thay đổi so với dòng iPhone 6, 6 Plus trước đó, điểm khác biệt mà Apple đã đưa vào hai sản phẩm mới này của mình nằm ở chất liệu khung máy bền bỉ hơn, công nghệ màn hình cảm ứng 3D Touch tối tân, nâng cấp cụm camera, ứng dụng chỉnh sửa ảnh kết hợp video Live Photos và không thể không nhắc đến việc nâng cấp lên chip xử lý A9 64-bit cho hiệu quả đáng kinh ngạc.
', NULL, CAST(16880000.00 AS Decimal(18, 2)), CAST(17380000.00 AS Decimal(18, 2)), 0, 1, N'iPhone 6s 16GB', N'iphone-6s-16gb', NULL, NULL, NULL, 1, NULL, 0, CAST(N'2016-03-15 22:52:49.610' AS DateTime), CAST(N'2016-03-15 22:52:49.610' AS DateTime), NULL, 12, NULL)

INSERT [dbo].[Core_Product] ([Id], [ShortDescription], [Description], [Specification], [Price], [OldPrice], [DisplayOrder], [BrandId], [Name], [SeoTitle], [MetaTitle], [MetaKeywords], [MetaDescription], [IsPublished], [PublishedOn], [IsDeleted], [CreatedOn], [UpdatedOn], [CreatedById], [ThumbnailImageId], [UpdatedById]) VALUES (3, N'Màn hình: FullHD, 5.2 inches
...
Tiếp nối thành công của dòng điện thoại A series, ông lớn Samsung tiếp tục ra mắt smartphoneSamsung Galaxy A5 (A510F) với phiên bản 2016 mạnh mẽ và chất lượng hơn so với thiết bị A5 tiền nhiệm. Siêu phẩm này sở hữu thiết kế khung nhôm, vỏ kính cực kỳ tinh tế và sành điệu, đồng thời, máy cũng được nâng cấp về cấu hình, dung lượng pin và màn hình kích thước lớn hơn, đáp ứng nhu cầu sử dụng, làm hài lòng các khách hàng khó tính nhất.
', NULL, CAST(8999000.00 AS Decimal(18, 2)), CAST(9999000.00 AS Decimal(18, 2)), 0, 2, N'Samsung Galaxy A5', N'samsung-galaxy-a5', NULL, NULL, NULL, 1, NULL, 0, CAST(N'2016-03-15 23:08:42.637' AS DateTime), CAST(N'2016-03-15 23:08:42.637' AS DateTime), NULL, 18, NULL)
