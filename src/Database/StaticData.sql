...
INSERT [dbo].[Core_Widget] ([Id], [Code], [CreateUrl], [CreatedOn], [EditUrl], [IsPublished], [Name], [ViewComponentName]) VALUES (3, N'ProductDisplayWidget', N'widget-product-display-create', CAST(N'2016-07-08 00:00:00.0000000' AS DateTime2), N'widget-product-display-edit', 1, N'Product Display Widget', N'ProductDisplayWidget')
