...
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Associate your {0} account.', N'Liên kết với tài khoản {0} của bạn')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Users', N'Người dùng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Vendors', N'Người bán')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Reviews', N'Đánh giá')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Products', N'Sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Categories', N'Danh mục')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Brands', N'Nhãn hiệu')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Product Options', N'Tùy chọn sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Product Attribute', N'Thuộc tính sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Product Attribute Groups', N'Nhóm thuộc tính sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Product Templates', N'Mẫu sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Sales', N'Bán hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Orders', N'Đơn hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Content Management', N'Quán lý nội dung')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Pages', N'Trang')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Widgets', N'Widgets')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'System', N'Hệ thống')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Configuration', N'Cấu hình')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Translations', N'Translations')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Dashboard', N'Dashboard')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Incomplete orders', N'Đơn hàng chưa xong')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Pending reviews', N'Đánh giá đang chờ duyệt')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Most search keywords', N'Từ khóa được tìm kiếm nhiều nhất')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Most viewed products', N'Sản phẩm được xem nhiều nhất')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'OrderId', N'Số đơn hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Order Status', N'Trạng thái đơn hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Customer', N'Khách hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Created On', N'Ngày tạo')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'SubTotal', N'Tổng tiền')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Actions', N'Hành động')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Site', N'Site')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Catalog', N'Quản lý sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Title', N'Tiêu đề')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Comment', N'Bình luận')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Status', N'Trạng thái')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Rating', N'Xếp hạng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Keyword', N'Từ khóa')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Count', N'Số lần')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Create User', N'Tạo người dùng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'FullName', N'Họ và tên')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Roles', N'Roles')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Edit User', N'Chỉnh sửa user')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Manager of Vendor', N'Manager of Vendor')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Save', N'Lưu lại')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Cancel', N'Hủy')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Phone Number', N'Số điện thoại')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Create Vendor', N'Tạo người bán')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Is Active', N'Đang hoạt động')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Edit Vendor', N'Chỉnh sửa người bán')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Managers', N'Quản lý')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Description', N'Mô tả')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Pending', N'Đang chờ')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Approved', N'Đã duyệt')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Not Approved', N'Không duyệt')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Approve', N'Duyệt')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Create Product', N'Tạo sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Has Options', N'Tùy chọn')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Is Visible Individually', N'Hiển thị riêng lẻ')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Is Featured', N'Nổi bậc')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Is Allowed To Order', N'Cho phép đặt hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Is Called For Pricing', N'Gọi để biết giá')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Stock Quantity', N'Số lượng trong kho')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Is Published', N'Công bố')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Yes', N'Có')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'No', N'Không')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Edit Product', N'Chỉnh sửa sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Product Name', N'Tên sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Short Description', N'Mô tả ngắn')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Specification', N'Thông số kỹ thuật')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Old Price', N'Giá cũ')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Special Price', N'Giá đặc biệt')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Special Price Start', N'Bắt đầu giá đặc biệt')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Special Price End', N'Kết thúc giá đặc biệt')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Thumbnail', N'Hình đại diện')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Product Images', N'Hình sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Product Documents', N'Tài liệu kỹ thuật')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Out Of Stock', N'Hết hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Available Options', N'Tùy chọn khả dụng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Add Option', N'Thêm tùy chọn')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Option Values', N'Giá trị của tùy chọn')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Delete Option', N'Xóa tùy chọn')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Generate Combinations', N'Tự động tạo tùy chọn sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Product Variations', N'Những tùy chọn sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Option Combinations', N'Sự kết hợp của những tùy chọn')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Images', N'Hình ảnh')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Apply', N'Áp dụng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Available Attributes', N'Đặt tính khả dụng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Add Attribute', N'Thêm đặc tính')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Product Attributes', N'Đặc tính của sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Attribute Name', N'Tên đặc tính')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Value', N'Giá trị')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'General Information', N'Thông tin chung')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Category Mapping', N'Danh mục')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Related Products', N'Sản phẩm tương tự')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Manage Related Products', N'Quản lý sản phẩm tương tự')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Create Category', N'Tạo danh mục')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Edit Category', N'Chỉnh sửa danh mục')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Create Brand', N'Tạo nhãn hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Edit Brand', N'Chỉnh sửa nhãn hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Name', N'Tên')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Parent Category', N'Danh mục cha')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Group', N'Nhóm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Create Product Attribute', N'Tạo đặt tính sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Edit Product Attribute', N'Chỉnh sửa đặt tính sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Create Product Attribute Group', N'Tạo nhóm đặt tính sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Edit Product Attribute Group', N'Chỉnh sửa nhóm đặt tính sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Create Product Option', N'Tạo tùy chọn sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Edit Product Option', N'Chỉnh sửa tùy chọn sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Create Product Display Widget', N'Create Product Display Widget')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Edit Product Display Widget', N'Edit Product Display Widget')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Widget Name', N'Widget Name')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Widget Zone', N'Widget Zone')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Publish Start', N'Thời gian bắt đầu công bố')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Publish End', N'Thời gian kết thúc')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Number of Products', N'Số lượng sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Order By', N'Sắp xếp theo')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Create Product Template', N'Tạo mẫu sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Edit Product Template', N'Chỉnh sửa mẫu sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Added Attributes', N'Những đặt tính đã thêm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Back', N'Quay về')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Order Detail', N'Chi tiết đơn hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Order Information', N'Thông tin đơn hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Change', N'Thay đổi')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Product Information', N'Thông tin sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Shipping Information', N'Thông tin giao hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Application Settings', N'Application Settings')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Create Page', N'Tạo trang')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Edit Page', N'Chỉnh sửa trang')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Body', N'Nội dung chính')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Account Dashboard', N'Quản lý tài khoản')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Account Information', N'Thông tin tài khoản')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Edit', N'Chỉnh sửa')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Security', N'Bảo mật')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Create', N'Tạo mới')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'External Logins', N'Đăng nhập từ mạng xã hội')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Manage', N'Quản lý')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Default shipping address', N'Địa chỉ nhận hàng mặc định')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Manage address', N'Quản lý địa chỉ')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'You don''t have any default address', N'Bạn chưa có địa chỉ mặc định nào')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Order History', N'Lịch sử mua hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Address Book', N'Sổ địa chỉ')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Add Address', N'Thêm địa chỉ')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Delete', N'Xóa')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Set as default shipping address', N'Chọn làm địa chỉ mặc định khi nhận hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Edit Address', N'Chỉnh sửa địa chỉ')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Create Address', N'Tạo địa chỉ mới')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Your account', N'Tài khoản của bạn')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (2, N'Date', N'Ngày')
...
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Associate your {0} account.', N'Liên kết với tài khoản {0} của bạn')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Users', N'Người dùng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Vendors', N'Người bán')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Reviews', N'Đánh giá')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Products', N'Sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Categories', N'Danh mục')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Brands', N'Nhãn hiệu')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Product Options', N'Tùy chọn sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Product Attribute', N'Thuộc tính sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Product Attribute Groups', N'Nhóm thuộc tính sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Product Templates', N'Mẫu sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Sales', N'Bán hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Orders', N'Đơn hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Content Management', N'Quán lý nội dung')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Pages', N'Trang')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Widgets', N'Widgets')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'System', N'Hệ thống')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Configuration', N'Cấu hình')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Translations', N'Translations')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Dashboard', N'Dashboard')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Incomplete orders', N'Đơn hàng chưa xong')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Pending reviews', N'Đánh giá đang chờ duyệt')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Most search keywords', N'Từ khóa được tìm kiếm nhiều nhất')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Most viewed products', N'Sản phẩm được xem nhiều nhất')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'OrderId', N'Số đơn hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Order Status', N'Trạng thái đơn hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Customer', N'Khách hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Created On', N'Ngày tạo')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'SubTotal', N'Tổng tiền')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Actions', N'Hành động')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Site', N'Site')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Catalog', N'Quản lý sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Title', N'Tiêu đề')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Comment', N'Bình luận')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Status', N'Trạng thái')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Rating', N'Xếp hạng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Keyword', N'Từ khóa')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Count', N'Số lần')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Create User', N'Tạo người dùng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'FullName', N'Họ và tên')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Roles', N'Roles')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Edit User', N'Chỉnh sửa user')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Manager of Vendor', N'Manager of Vendor')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Save', N'Lưu lại')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Cancel', N'Hủy')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Phone Number', N'Số điện thoại')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Create Vendor', N'Tạo người bán')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Is Active', N'Đang hoạt động')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Edit Vendor', N'Chỉnh sửa người bán')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Managers', N'Quản lý')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Description', N'Mô tả')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Pending', N'Đang chờ')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Approved', N'Đã duyệt')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Not Approved', N'Không duyệt')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Approve', N'Duyệt')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Create Product', N'Tạo sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Has Options', N'Tùy chọn')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Is Visible Individually', N'Hiển thị riêng lẻ')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Is Featured', N'Nổi bậc')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Is Allowed To Order', N'Cho phép đặt hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Is Called For Pricing', N'Gọi để biết giá')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Stock Quantity', N'Số lượng trong kho')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Is Published', N'Công bố')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Yes', N'Có')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'No', N'Không')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Edit Product', N'Chỉnh sửa sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Product Name', N'Tên sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Short Description', N'Mô tả ngắn')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Specification', N'Thông số kỹ thuật')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Old Price', N'Giá cũ')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Special Price', N'Giá đặc biệt')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Special Price Start', N'Bắt đầu giá đặc biệt')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Special Price End', N'Kết thúc giá đặc biệt')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Thumbnail', N'Hình đại diện')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Product Images', N'Hình sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Product Documents', N'Tài liệu kỹ thuật')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Out Of Stock', N'Hết hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Available Options', N'Tùy chọn khả dụng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Add Option', N'Thêm tùy chọn')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Option Values', N'Giá trị của tùy chọn')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Delete Option', N'Xóa tùy chọn')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Generate Combinations', N'Tự động tạo tùy chọn sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Product Variations', N'Những tùy chọn sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Option Combinations', N'Sự kết hợp của những tùy chọn')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Images', N'Hình ảnh')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Apply', N'Áp dụng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Available Attributes', N'Đặt tính khả dụng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Add Attribute', N'Thêm đặc tính')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Product Attributes', N'Đặc tính của sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Attribute Name', N'Tên đặc tính')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Value', N'Giá trị')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'General Information', N'Thông tin chung')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Category Mapping', N'Danh mục')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Related Products', N'Sản phẩm tương tự')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Manage Related Products', N'Quản lý sản phẩm tương tự')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Create Category', N'Tạo danh mục')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Edit Category', N'Chỉnh sửa danh mục')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Create Brand', N'Tạo nhãn hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Edit Brand', N'Chỉnh sửa nhãn hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Name', N'Tên')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Parent Category', N'Danh mục cha')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Group', N'Nhóm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Create Product Attribute', N'Tạo đặt tính sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Edit Product Attribute', N'Chỉnh sửa đặt tính sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Create Product Attribute Group', N'Tạo nhóm đặt tính sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Edit Product Attribute Group', N'Chỉnh sửa nhóm đặt tính sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Create Product Option', N'Tạo tùy chọn sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Edit Product Option', N'Chỉnh sửa tùy chọn sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Create Product Display Widget', N'Create Product Display Widget')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Edit Product Display Widget', N'Edit Product Display Widget')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Widget Name', N'Widget Name')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Widget Zone', N'Widget Zone')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Publish Start', N'Thời gian bắt đầu công bố')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Publish End', N'Thời gian kết thúc')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Number of Products', N'Số lượng sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Order By', N'Sắp xếp theo')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Create Product Template', N'Tạo mẫu sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Edit Product Template', N'Chỉnh sửa mẫu sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Added Attributes', N'Những đặt tính đã thêm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Back', N'Quay về')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Order Detail', N'Chi tiết đơn hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Order Information', N'Thông tin đơn hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Change', N'Thay đổi')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Product Information', N'Thông tin sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Shipping Information', N'Thông tin giao hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Application Settings', N'Application Settings')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Create Page', N'Tạo trang')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Edit Page', N'Chỉnh sửa trang')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Body', N'Nội dung chính')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Account Dashboard', N'Quản lý tài khoản')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Account Information', N'Thông tin tài khoản')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Edit', N'Chỉnh sửa')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Security', N'Bảo mật')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Create', N'Tạo mới')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'External Logins', N'Đăng nhập từ mạng xã hội')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Manage', N'Quản lý')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Default shipping address', N'Địa chỉ nhận hàng mặc định')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Manage address', N'Quản lý địa chỉ')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'You don''t have any default address', N'Bạn chưa có địa chỉ mặc định nào')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Order History', N'Lịch sử mua hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Address Book', N'Sổ địa chỉ')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Add Address', N'Thêm địa chỉ')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Delete', N'Xóa')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Set as default shipping address', N'Chọn làm địa chỉ mặc định khi nhận hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Edit Address', N'Chỉnh sửa địa chỉ')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Create Address', N'Tạo địa chỉ mới')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Your account', N'Tài khoản của bạn')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (3, N'Date', N'Ngày')
...
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Associate your {0} account.', N'Liên kết với tài khoản {0} của bạn')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Users', N'Người dùng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Vendors', N'Người bán')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Reviews', N'Đánh giá')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Products', N'Sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Categories', N'Danh mục')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Brands', N'Nhãn hiệu')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Product Options', N'Tùy chọn sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Product Attribute', N'Thuộc tính sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Product Attribute Groups', N'Nhóm thuộc tính sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Product Templates', N'Mẫu sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Sales', N'Bán hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Orders', N'Đơn hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Content Management', N'Quán lý nội dung')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Pages', N'Trang')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Widgets', N'Widgets')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'System', N'Hệ thống')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Configuration', N'Cấu hình')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Translations', N'Translations')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Dashboard', N'Dashboard')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Incomplete orders', N'Đơn hàng chưa xong')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Pending reviews', N'Đánh giá đang chờ duyệt')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Most search keywords', N'Từ khóa được tìm kiếm nhiều nhất')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Most viewed products', N'Sản phẩm được xem nhiều nhất')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'OrderId', N'Số đơn hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Order Status', N'Trạng thái đơn hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Customer', N'Khách hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Created On', N'Ngày tạo')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'SubTotal', N'Tổng tiền')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Actions', N'Hành động')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Site', N'Site')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Catalog', N'Quản lý sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Title', N'Tiêu đề')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Comment', N'Bình luận')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Status', N'Trạng thái')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Rating', N'Xếp hạng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Keyword', N'Từ khóa')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Count', N'Số lần')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Create User', N'Tạo người dùng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'FullName', N'Họ và tên')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Roles', N'Roles')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Edit User', N'Chỉnh sửa user')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Manager of Vendor', N'Manager of Vendor')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Save', N'Lưu lại')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Cancel', N'Hủy')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Phone Number', N'Số điện thoại')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Create Vendor', N'Tạo người bán')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Is Active', N'Đang hoạt động')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Edit Vendor', N'Chỉnh sửa người bán')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Managers', N'Quản lý')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Description', N'Mô tả')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Pending', N'Đang chờ')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Approved', N'Đã duyệt')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Not Approved', N'Không duyệt')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Approve', N'Duyệt')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Create Product', N'Tạo sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Has Options', N'Tùy chọn')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Is Visible Individually', N'Hiển thị riêng lẻ')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Is Featured', N'Nổi bậc')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Is Allowed To Order', N'Cho phép đặt hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Is Called For Pricing', N'Gọi để biết giá')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Stock Quantity', N'Số lượng trong kho')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Is Published', N'Công bố')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Yes', N'Có')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'No', N'Không')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Edit Product', N'Chỉnh sửa sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Product Name', N'Tên sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Short Description', N'Mô tả ngắn')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Specification', N'Thông số kỹ thuật')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Old Price', N'Giá cũ')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Special Price', N'Giá đặc biệt')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Special Price Start', N'Bắt đầu giá đặc biệt')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Special Price End', N'Kết thúc giá đặc biệt')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Thumbnail', N'Hình đại diện')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Product Images', N'Hình sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Product Documents', N'Tài liệu kỹ thuật')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Out Of Stock', N'Hết hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Available Options', N'Tùy chọn khả dụng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Add Option', N'Thêm tùy chọn')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Option Values', N'Giá trị của tùy chọn')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Delete Option', N'Xóa tùy chọn')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Generate Combinations', N'Tự động tạo tùy chọn sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Product Variations', N'Những tùy chọn sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Option Combinations', N'Sự kết hợp của những tùy chọn')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Images', N'Hình ảnh')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Apply', N'Áp dụng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Available Attributes', N'Đặt tính khả dụng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Add Attribute', N'Thêm đặc tính')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Product Attributes', N'Đặc tính của sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Attribute Name', N'Tên đặc tính')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Value', N'Giá trị')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'General Information', N'Thông tin chung')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Category Mapping', N'Danh mục')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Related Products', N'Sản phẩm tương tự')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Manage Related Products', N'Quản lý sản phẩm tương tự')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Create Category', N'Tạo danh mục')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Edit Category', N'Chỉnh sửa danh mục')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Create Brand', N'Tạo nhãn hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Edit Brand', N'Chỉnh sửa nhãn hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Name', N'Tên')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Parent Category', N'Danh mục cha')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Group', N'Nhóm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Create Product Attribute', N'Tạo đặt tính sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Edit Product Attribute', N'Chỉnh sửa đặt tính sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Create Product Attribute Group', N'Tạo nhóm đặt tính sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Edit Product Attribute Group', N'Chỉnh sửa nhóm đặt tính sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Create Product Option', N'Tạo tùy chọn sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Edit Product Option', N'Chỉnh sửa tùy chọn sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Create Product Display Widget', N'Create Product Display Widget')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Edit Product Display Widget', N'Edit Product Display Widget')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Widget Name', N'Widget Name')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Widget Zone', N'Widget Zone')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Publish Start', N'Thời gian bắt đầu công bố')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Publish End', N'Thời gian kết thúc')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Number of Products', N'Số lượng sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Order By', N'Sắp xếp theo')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Create Product Template', N'Tạo mẫu sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Edit Product Template', N'Chỉnh sửa mẫu sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Added Attributes', N'Những đặt tính đã thêm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Back', N'Quay về')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Order Detail', N'Chi tiết đơn hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Order Information', N'Thông tin đơn hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Change', N'Thay đổi')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Product Information', N'Thông tin sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Shipping Information', N'Thông tin giao hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Application Settings', N'Application Settings')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Create Page', N'Tạo trang')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Edit Page', N'Chỉnh sửa trang')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Body', N'Nội dung chính')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Account Dashboard', N'Quản lý tài khoản')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Account Information', N'Thông tin tài khoản')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Edit', N'Chỉnh sửa')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Security', N'Bảo mật')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Create', N'Tạo mới')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'External Logins', N'Đăng nhập từ mạng xã hội')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Manage', N'Quản lý')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Default shipping address', N'Địa chỉ nhận hàng mặc định')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Manage address', N'Quản lý địa chỉ')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'You don''t have any default address', N'Bạn chưa có địa chỉ mặc định nào')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Order History', N'Lịch sử mua hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Address Book', N'Sổ địa chỉ')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Add Address', N'Thêm địa chỉ')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Delete', N'Xóa')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Set as default shipping address', N'Chọn làm địa chỉ mặc định khi nhận hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Edit Address', N'Chỉnh sửa địa chỉ')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Create Address', N'Tạo địa chỉ mới')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Your account', N'Tài khoản của bạn')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (4, N'Date', N'Ngày')
...
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Associate your {0} account.', N'Liên kết với tài khoản {0} của bạn')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Users', N'Người dùng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Vendors', N'Người bán')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Reviews', N'Đánh giá')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Products', N'Sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Categories', N'Danh mục')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Brands', N'Nhãn hiệu')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Product Options', N'Tùy chọn sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Product Attribute', N'Thuộc tính sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Product Attribute Groups', N'Nhóm thuộc tính sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Product Templates', N'Mẫu sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Sales', N'Bán hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Orders', N'Đơn hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Content Management', N'Quán lý nội dung')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Pages', N'Trang')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Widgets', N'Widgets')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'System', N'Hệ thống')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Configuration', N'Cấu hình')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Translations', N'Translations')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Dashboard', N'Dashboard')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Incomplete orders', N'Đơn hàng chưa xong')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Pending reviews', N'Đánh giá đang chờ duyệt')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Most search keywords', N'Từ khóa được tìm kiếm nhiều nhất')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Most viewed products', N'Sản phẩm được xem nhiều nhất')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'OrderId', N'Số đơn hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Order Status', N'Trạng thái đơn hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Customer', N'Khách hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Created On', N'Ngày tạo')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'SubTotal', N'Tổng tiền')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Actions', N'Hành động')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Site', N'Site')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Catalog', N'Quản lý sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Title', N'Tiêu đề')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Comment', N'Bình luận')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Status', N'Trạng thái')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Rating', N'Xếp hạng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Keyword', N'Từ khóa')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Count', N'Số lần')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Create User', N'Tạo người dùng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'FullName', N'Họ và tên')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Roles', N'Roles')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Edit User', N'Chỉnh sửa user')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Manager of Vendor', N'Manager of Vendor')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Save', N'Lưu lại')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Cancel', N'Hủy')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Phone Number', N'Số điện thoại')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Create Vendor', N'Tạo người bán')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Is Active', N'Đang hoạt động')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Edit Vendor', N'Chỉnh sửa người bán')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Managers', N'Quản lý')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Description', N'Mô tả')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Pending', N'Đang chờ')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Approved', N'Đã duyệt')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Not Approved', N'Không duyệt')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Approve', N'Duyệt')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Create Product', N'Tạo sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Has Options', N'Tùy chọn')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Is Visible Individually', N'Hiển thị riêng lẻ')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Is Featured', N'Nổi bậc')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Is Allowed To Order', N'Cho phép đặt hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Is Called For Pricing', N'Gọi để biết giá')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Stock Quantity', N'Số lượng trong kho')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Is Published', N'Công bố')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Yes', N'Có')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'No', N'Không')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Edit Product', N'Chỉnh sửa sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Product Name', N'Tên sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Short Description', N'Mô tả ngắn')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Specification', N'Thông số kỹ thuật')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Old Price', N'Giá cũ')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Special Price', N'Giá đặc biệt')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Special Price Start', N'Bắt đầu giá đặc biệt')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Special Price End', N'Kết thúc giá đặc biệt')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Thumbnail', N'Hình đại diện')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Product Images', N'Hình sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Product Documents', N'Tài liệu kỹ thuật')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Out Of Stock', N'Hết hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Available Options', N'Tùy chọn khả dụng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Add Option', N'Thêm tùy chọn')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Option Values', N'Giá trị của tùy chọn')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Delete Option', N'Xóa tùy chọn')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Generate Combinations', N'Tự động tạo tùy chọn sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Product Variations', N'Những tùy chọn sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Option Combinations', N'Sự kết hợp của những tùy chọn')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Images', N'Hình ảnh')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Apply', N'Áp dụng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Available Attributes', N'Đặt tính khả dụng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Add Attribute', N'Thêm đặc tính')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Product Attributes', N'Đặc tính của sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Attribute Name', N'Tên đặc tính')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Value', N'Giá trị')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'General Information', N'Thông tin chung')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Category Mapping', N'Danh mục')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Related Products', N'Sản phẩm tương tự')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Manage Related Products', N'Quản lý sản phẩm tương tự')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Create Category', N'Tạo danh mục')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Edit Category', N'Chỉnh sửa danh mục')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Create Brand', N'Tạo nhãn hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Edit Brand', N'Chỉnh sửa nhãn hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Name', N'Tên')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Parent Category', N'Danh mục cha')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Group', N'Nhóm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Create Product Attribute', N'Tạo đặt tính sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Edit Product Attribute', N'Chỉnh sửa đặt tính sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Create Product Attribute Group', N'Tạo nhóm đặt tính sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Edit Product Attribute Group', N'Chỉnh sửa nhóm đặt tính sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Create Product Option', N'Tạo tùy chọn sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Edit Product Option', N'Chỉnh sửa tùy chọn sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Create Product Display Widget', N'Create Product Display Widget')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Edit Product Display Widget', N'Edit Product Display Widget')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Widget Name', N'Widget Name')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Widget Zone', N'Widget Zone')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Publish Start', N'Thời gian bắt đầu công bố')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Publish End', N'Thời gian kết thúc')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Number of Products', N'Số lượng sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Order By', N'Sắp xếp theo')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Create Product Template', N'Tạo mẫu sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Edit Product Template', N'Chỉnh sửa mẫu sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Added Attributes', N'Những đặt tính đã thêm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Back', N'Quay về')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Order Detail', N'Chi tiết đơn hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Order Information', N'Thông tin đơn hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Change', N'Thay đổi')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Product Information', N'Thông tin sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Shipping Information', N'Thông tin giao hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Application Settings', N'Application Settings')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Create Page', N'Tạo trang')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Edit Page', N'Chỉnh sửa trang')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Body', N'Nội dung chính')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Account Dashboard', N'Quản lý tài khoản')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Account Information', N'Thông tin tài khoản')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Edit', N'Chỉnh sửa')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Security', N'Bảo mật')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Create', N'Tạo mới')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'External Logins', N'Đăng nhập từ mạng xã hội')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Manage', N'Quản lý')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Default shipping address', N'Địa chỉ nhận hàng mặc định')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Manage address', N'Quản lý địa chỉ')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'You don''t have any default address', N'Bạn chưa có địa chỉ mặc định nào')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Order History', N'Lịch sử mua hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Address Book', N'Sổ địa chỉ')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Add Address', N'Thêm địa chỉ')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Delete', N'Xóa')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Set as default shipping address', N'Chọn làm địa chỉ mặc định khi nhận hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Edit Address', N'Chỉnh sửa địa chỉ')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Create Address', N'Tạo địa chỉ mới')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Your account', N'Tài khoản của bạn')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (5, N'Date', N'Ngày')
...
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Content Management', N'Quán lý nội dung')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Pages', N'Trang')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Widgets', N'Widgets')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'System', N'Hệ thống')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Configuration', N'Cấu hình')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Translations', N'Translations')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Dashboard', N'Dashboard')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Incomplete orders', N'Đơn hàng chưa xong')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Pending reviews', N'Đánh giá đang chờ duyệt')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Most search keywords', N'Từ khóa được tìm kiếm nhiều nhất')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Most viewed products', N'Sản phẩm được xem nhiều nhất')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'OrderId', N'Số đơn hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Order Status', N'Trạng thái đơn hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Customer', N'Khách hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Created On', N'Ngày tạo')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'SubTotal', N'Tổng tiền')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Actions', N'Hành động')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Site', N'Site')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Catalog', N'Quản lý sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Title', N'Tiêu đề')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Comment', N'Bình luận')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Status', N'Trạng thái')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Rating', N'Xếp hạng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Keyword', N'Từ khóa')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Count', N'Số lần')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Create User', N'Tạo người dùng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'FullName', N'Họ và tên')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Roles', N'Roles')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Edit User', N'Chỉnh sửa user')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Manager of Vendor', N'Manager of Vendor')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Save', N'Lưu lại')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Cancel', N'Hủy')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Phone Number', N'Số điện thoại')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Create Vendor', N'Tạo người bán')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Is Active', N'Đang hoạt động')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Edit Vendor', N'Chỉnh sửa người bán')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Managers', N'Quản lý')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Description', N'Mô tả')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Pending', N'Đang chờ')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Approved', N'Đã duyệt')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Not Approved', N'Không duyệt')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Approve', N'Duyệt')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Create Product', N'Tạo sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Has Options', N'Tùy chọn')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Is Visible Individually', N'Hiển thị riêng lẻ')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Is Featured', N'Nổi bậc')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Is Allowed To Order', N'Cho phép đặt hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Is Called For Pricing', N'Gọi để biết giá')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Stock Quantity', N'Số lượng trong kho')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Is Published', N'Công bố')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Yes', N'Có')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'No', N'Không')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Edit Product', N'Chỉnh sửa sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Product Name', N'Tên sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Short Description', N'Mô tả ngắn')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Specification', N'Thông số kỹ thuật')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Old Price', N'Giá cũ')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Special Price', N'Giá đặc biệt')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Special Price Start', N'Bắt đầu giá đặc biệt')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Special Price End', N'Kết thúc giá đặc biệt')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Thumbnail', N'Hình đại diện')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Product Images', N'Hình sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Product Documents', N'Tài liệu kỹ thuật')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Out Of Stock', N'Hết hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Available Options', N'Tùy chọn khả dụng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Add Option', N'Thêm tùy chọn')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Option Values', N'Giá trị của tùy chọn')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Delete Option', N'Xóa tùy chọn')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Generate Combinations', N'Tự động tạo tùy chọn sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Product Variations', N'Những tùy chọn sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Option Combinations', N'Sự kết hợp của những tùy chọn')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Images', N'Hình ảnh')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Apply', N'Áp dụng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Available Attributes', N'Đặt tính khả dụng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Add Attribute', N'Thêm đặc tính')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Product Attributes', N'Đặc tính của sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Attribute Name', N'Tên đặc tính')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Value', N'Giá trị')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'General Information', N'Thông tin chung')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Category Mapping', N'Danh mục')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Related Products', N'Sản phẩm tương tự')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Manage Related Products', N'Quản lý sản phẩm tương tự')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Create Category', N'Tạo danh mục')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Edit Category', N'Chỉnh sửa danh mục')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Create Brand', N'Tạo nhãn hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Edit Brand', N'Chỉnh sửa nhãn hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Name', N'Tên')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Parent Category', N'Danh mục cha')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Group', N'Nhóm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Create Product Attribute', N'Tạo đặt tính sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Edit Product Attribute', N'Chỉnh sửa đặt tính sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Create Product Attribute Group', N'Tạo nhóm đặt tính sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Edit Product Attribute Group', N'Chỉnh sửa nhóm đặt tính sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Create Product Option', N'Tạo tùy chọn sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Edit Product Option', N'Chỉnh sửa tùy chọn sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Create Product Display Widget', N'Create Product Display Widget')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Edit Product Display Widget', N'Edit Product Display Widget')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Widget Name', N'Widget Name')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Widget Zone', N'Widget Zone')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Publish Start', N'Thời gian bắt đầu công bố')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Publish End', N'Thời gian kết thúc')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Number of Products', N'Số lượng sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Order By', N'Sắp xếp theo')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Create Product Template', N'Tạo mẫu sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Edit Product Template', N'Chỉnh sửa mẫu sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Added Attributes', N'Những đặt tính đã thêm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Back', N'Quay về')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Order Detail', N'Chi tiết đơn hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Order Information', N'Thông tin đơn hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Change', N'Thay đổi')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Product Information', N'Thông tin sản phẩm')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Shipping Information', N'Thông tin giao hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Application Settings', N'Application Settings')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Create Page', N'Tạo trang')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Edit Page', N'Chỉnh sửa trang')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Body', N'Nội dung chính')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Account Dashboard', N'Quản lý tài khoản')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Account Information', N'Thông tin tài khoản')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Edit', N'Chỉnh sửa')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Security', N'Bảo mật')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Create', N'Tạo mới')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'External Logins', N'Đăng nhập từ mạng xã hội')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Manage', N'Quản lý')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Default shipping address', N'Địa chỉ nhận hàng mặc định')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Manage address', N'Quản lý địa chỉ')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'You don''t have any default address', N'Bạn chưa có địa chỉ mặc định nào')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Order History', N'Lịch sử mua hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Address Book', N'Sổ địa chỉ')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Add Address', N'Thêm địa chỉ')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Delete', N'Xóa')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Set as default shipping address', N'Chọn làm địa chỉ mặc định khi nhận hàng')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Edit Address', N'Chỉnh sửa địa chỉ')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Create Address', N'Tạo địa chỉ mới')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Your account', N'Tài khoản của bạn')
INSERT [dbo].[Localization_Resource] ([CultureId], [Key], [Value]) VALUES (7, N'Date', N'Ngày')
