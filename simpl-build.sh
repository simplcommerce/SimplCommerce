...
sed -i'' -e 's|<PackageReference Include="Microsoft.EntityFrameworkCore.SqlServer" Version="2.1.0-rc1-final" />|<PackageReference Include="Npgsql.EntityFrameworkCore.PostgreSQL" Version="2.0.2" />|' src/SimplCommerce.WebHost/SimplCommerce.WebHost.csproj
