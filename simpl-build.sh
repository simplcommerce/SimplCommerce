...
sed -i'' -e 's|<PackageReference Include="Microsoft.EntityFrameworkCore.SqlServer" Version="2.1.0" />|<PackageReference Include="Npgsql.EntityFrameworkCore.PostgreSQL" Version="2.1.0-rc1" />|' src/SimplCommerce.WebHost/SimplCommerce.WebHost.csproj
