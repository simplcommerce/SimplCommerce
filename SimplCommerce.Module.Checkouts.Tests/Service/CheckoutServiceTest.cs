...
namespace SimplCommerce.Module.Checkouts.Tests.Service
{
	public class CheckoutServiceTest
	{
        ...
        public async Task Create_ValidData_CheckoutCreatedSuccessfully()
        {
            ...
            {
                new CartItemToCheckoutVm { ProductId = 101, Quantity = 2 },
                new CartItemToCheckoutVm { ProductId = 102, Quantity = 1 }
            };
